    ...
    <div className="pt-12 pb-8">
      <div className="px-8 flex flex-col sm:flex-row justify-between items-center">
        <div className="w-[200px] flex flex-col order-3 sm:order-1 mt-4">
          <button className="footer-link !text-center sm:!text-left font-semibold" type="button" onClick={() => {
            navigate("/policy");
          }}>Terms & Conditions</button>
          <button className="footer-link !text-center sm:!text-left font-semibold !mt-3" type="button" onClick={() => {
            navigate("/policy");
